...
$data = mysqli_query($conn, "SELECT * FROM soal WHERE mode='php'");
$result = mysqli_num_rows($data);
$totalHalaman = ceil($result / $dataPerHalaman);

// Menampilkan soal dari database
$soal = mysqli_query($conn, "SELECT * FROM soal WHERE mode='php' AND aktif='Y' LIMIT $halamanAwal,$dataPerHalaman");
$i = $halamanAwal + 1;
